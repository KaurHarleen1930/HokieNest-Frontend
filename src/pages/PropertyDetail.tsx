...
import { HousingScoreWithPriorities } from "@/components/HousingScoreWithPriorities";
            ...
            <div className="mt-6">
              <HousingScoreWithPriorities
                property={{
                  ...
                  roommateCompatibility: listing.roommateCompatibility,
                }}
              />
            </div>
          </div>
